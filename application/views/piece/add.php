    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Piece Add</h3>
            </div>
            <?php echo form_open('piece/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="Date_Piece" value="<?php echo $this->input->post('Date_Piece'); ?>" class="form-control" id="Date_Piece" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="Nom_Piece" class="control-label">Nom Piece</label>
						<div class="form-group">
							<input type="text" name="Nom_Piece" value="<?php echo $this->input->post('Nom_Piece'); ?>" class="form-control" id="Nom_Piece" />
						</div>
					</div>
				</div>
			</div>
